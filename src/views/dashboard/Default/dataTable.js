        ...
        <ThemeProvider theme={theme}>
            <main className={classes.mainTwo}>
                <Container maxWidth="xl">
                    ...
                    <Grid container display="flex" justifyContent="left" sx={{ p: 5 }} gap={3}>
                        <Grid item sm={3} md={2}>
                            <Button variant="contained" className={classes.defaultBtnCompare}>
                                Compare
                            </Button>
                        </Grid>
                    </Grid>
                    <Grid container display="flex" justifyContent="right" sx={{ p: 5 }} gap={3}>
                        <Grid item sm={3} md={2}>
